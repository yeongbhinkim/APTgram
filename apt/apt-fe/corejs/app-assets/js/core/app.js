...
(function(window, document, $) {
    ...
    // $(window).on('load', function() {
       $(function windowLoad() { // 로그인 후 window onload 호출x 수정 20181026_PSJ
        var rtl;
...
// tooltip is not a function err - 20181026_PSJ
...
// carousel is not a function err - 20181026_PSJ
    // $('.carousel').carousel({
    //     interval: 2000
    // });
...
// 로그인 후 window onload 호출x 수정 20181026_PSJ
        $.windowLoad;
